...
class Event(models.Model):
    ...
    @property
    def url(self):
        url = reverse('events:event_detial_view_add_slug', kwargs={'pk': self.id})
...
class Performance(models.Model):
    ...
    def url(self):
        ...
        if pgpr and isinstance(pgpr, Group):
            return reverse('groups:group_detail_view_add_slug', kwargs={'pk': pgpr.id})
        elif pgpr and isinstance(pgpr, Performer):
            return reverse('performers:performer_detail_view_add_slug', kwargs={'pk': pgpr.id})
        else:
            return '#'
