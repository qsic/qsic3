...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'QSICPic.description'
        db.delete_column('qsic_qsicpic', 'description')

        # Adding field 'QSICPic.caption'
        db.add_column('qsic_qsicpic', 'caption',
                      self.gf('django.db.models.fields.CharField')(blank=True, default='', max_length=128),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'QSICPic.description'
        db.add_column('qsic_qsicpic', 'description',
                      self.gf('django.db.models.fields.CharField')(blank=True, default='', max_length=256),
                      keep_default=False)

        # Deleting field 'QSICPic.caption'
        db.delete_column('qsic_qsicpic', 'caption')
